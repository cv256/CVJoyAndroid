...
public class BaseUdpReceiver
{
    ...
    public void StartDebug()
    {
        Xamarin.Forms.Device.StartTimer(TimeSpan.FromMilliseconds(100), () =>
        {
            ...
            {
                recvBuffer[x] = (Byte)new Random().Next(9);
            }
            setData(recvBuffer);
            return true;
        });
    ...
    public UInt16 Rpm1024()
    {
        ...
        return Math.Min((UInt16)(Info.rpm * 1024 / InfoExtra.rpmMax), (UInt16)1023);
    }
    ...
    {
        UInt16 r = Rpm1024();
        return Color.FromArgb(127 + Convert.ToInt16(r / 8), r / 4, 255 - r / 4, 0);
    }
